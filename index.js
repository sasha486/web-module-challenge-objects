...
console.log(createMenuItem("pie", 6, "dessert"));
...
function getReviewByIndex(array, index) {
  let string = `${reviews[index].name} gave the restaurant a ${reviews[index].rating} star review, and their feedback was: ${reviews[index].feedback}`;
  return string;
}
...
function getLastReview(array) {
  let lastReview = `${reviews[reviews.length - 2].name} gave the restaurant a ${
    reviews[reviews.length - 2].rating
...
getReviewByRating(reviews, rating);
